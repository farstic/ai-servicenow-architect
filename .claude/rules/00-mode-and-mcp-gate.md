<!-- GENERATED by scripts/gen-governance.mjs from packages/snowarch/dist/contract.json (sha256 1874983e74db) — do not edit; edit packages/contract/gen/rule-file.mjs and run npm run gen -->
