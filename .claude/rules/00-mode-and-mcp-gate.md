<!-- GENERATED by scripts/gen-governance.mjs from packages/snowarch/dist/contract.json (sha256 3d1e0ef6daf3) — do not edit; edit packages/contract/gen/rule-file.mjs and run npm run gen -->
