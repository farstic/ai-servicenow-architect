<!-- GENERATED by scripts/gen-governance.mjs from packages/snowarch/dist/contract.json (sha256 672bb8aae585) — do not edit; edit packages/contract/gen/rule-file.mjs and run npm run gen -->
