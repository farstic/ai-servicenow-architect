<!-- GENERATED by scripts/gen-governance.mjs from packages/snowarch/dist/contract.json (sha256 8312efa92e9d) — do not edit; edit packages/contract/gen/rule-file.mjs and run npm run gen -->
