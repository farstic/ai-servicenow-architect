<!-- GENERATED by scripts/gen-governance.mjs from packages/snowarch/dist/contract.json (sha256 b7ffa1686205) — do not edit; edit packages/contract/gen/rule-file.mjs and run npm run gen -->
...
- `*_NOT_ENABLED` → ./snowarch instance set-preset <label> pdi-developer (a `prod` instance additionally needs `--ack-prod`).
