...
export const USAGE = [
// help-begin (generated by scripts/gen-cli-help.mjs — do not edit)
  'usage: ./snowarch instance <command> [options]',
  '',
  '  add <label>      add an instance (the wizard)',
  '  list             the instances this checkout can reach, and their last probe',
  '  test             re-probe one instance (or --all --json); writes only lastProbe',
  '  set-credentials  new username/password; saved only if the instance says ok',
  '  set-preset       change the preset (production needs --ack-prod)',
  '  set-flags        change individual flags: WRITE=on CMDB_WRITE=off …',
  '  set-default      which instance the server starts with',
  '  remove           delete an instance and its stored credentials',
  '  import           migrate a snow-mcp 1.x store (--from-legacy), plan first',
// help-end
  '',
