 ...
 */
async function gatherData(client, recommendedTools, args) {
    const results = {};
 ...
 */
function createClientFromConfig(instanceName) {
 ...
 */
export async function executeDirectly(options) {
    ...
    // 5. Call LLM
    const response = await callLlm(options.llmConfig, messages);
    return {
