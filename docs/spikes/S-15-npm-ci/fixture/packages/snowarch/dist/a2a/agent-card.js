...
function getDomainPrefix(toolName) {
    ...
    // Generic tools
    if (['snow_core_records_query', 'snow_core_record_read', 'snow_core_record_add', 'snow_core_record_modify', 'snow_core_record_remove', 'snow_core_table_schema_read', 'snow_core_user_read', 'snow_core_group_read'].includes(toolName))
        return 'core';
