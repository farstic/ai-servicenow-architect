...
All notable changes to this project are documented in this file. Everything except the `### Notes`
block under `## Unreleased` is generated by `scripts/release.mjs` — edit the Notes, nothing else.
