...
**Totals.** 134 stories: ARC-00 14 · ARC-01 12 · ARC-02 13 · ARC-03 11 · ARC-04 14 · ARC-05 12 · ARC-06 14 · ARC-07 11 · ARC-08 11 · ARC-09 12 · ARC-10 10. Sizes: S 25 · M 85 · L 24.
...
| ARC-06-S12 | ARC-06 | `snowarch mode live` / `mode design` post-install switches; `mode live --register local\|user` fallback | M | S07, S08, S09 | M3 | Done (2026-09-10) — AC 1/2/4/5/6 CLI halves deferred to the owner sitting (~/.claude.json) |
| ARC-06-S13 | ARC-06 | `docs/INSTALL.md` (= README body); Path B recipe sentence and non-empty-folder clone sequence; uninstall; start-at-root note | M | S09, S10, S11, S12; ARC-00-S10; ARC-03-S10; verdicts S-09 | M3 | Done (2026-09-10) — AC 1 reader two and AC 2 (Path B) deferred to the owner sitting; see OWNER-SITTING.md |
| ARC-06-S14 | ARC-06 | CI: design-only bootstrap on three OSes with and without Node; Windows job without Git Bash; no-tracked-file-modified and secret-grep gates | M | S10, S11; ARC-00-S13; ARC-01-S11 | M3 | Done (2026-09-10) — 13 cells; ARC-06 complete |
| ARC-07-S01 | ARC-07 | Masked-input module (`process.stdin.setRawMode`), `--password-stdin`, the no-TTY rule | M | ARC-00-S07; ARC-04-S01; verdicts S-04 | M3 | Done (2026-09-10) — AC 6 (the 8-cell Windows S-04 matrix) deferred to the owner sitting |
| ARC-07-S02 | ARC-07 | URL normalisation and validation; environment proposal; reachability probe with DNS / TLS-CA / proxy diagnosis (R-3) | M | ARC-04-S11; ARC-05-S06 | M3 | Done (2026-09-10) — task 4 is S05/S06; the two live network checks deferred to the owner sitting |
| ARC-07-S03 | ARC-07 | Probe library: auth probe (basic, ROPC), 401/403 mapping, `OAUTH_ROPC_DISABLED`, role hints, per-flag capability probes, `lastProbe` record | M | S02; ARC-04-S02/S03/S12 | M3 | Done (2026-09-10) — live ROPC bodies recorded by S11; the doctor binds probeAll in ARC-08-S04 |
| ARC-07-S04 | ARC-07 | Preset proposal and the per-flag review screen (Propose → Review → Apply); prod cap in the wizard; `--yes` / `--preset` / `--flags` | M | S03; ARC-04-S03/S06 | M3 | Done (2026-09-10) — task 4 (step order) is S05; AC 5/7/8 proven at function level here |
| ARC-07-S05 | ARC-07 | `instance add` end to end: bounded credential re-entry, atomic 0600 save, secret-free summary, the `./snowarch instance` forwarder, exit codes | L | S01, S04; ARC-04-S02/S10; ARC-06-S02/S07 | M3 | Done (2026-09-10; reworked same day — argument pass-through through the launchers, AC 11) — AC 1/2/9-spawned/10 deferred to the owner sitting (a real instance and a terminal) |
| ARC-07-S06 | ARC-07 | `instance list · test (incl. --all --json) · set-credentials · set-preset (--ack-prod) · set-flags · set-default · remove` | M | S05; ARC-04-S03/S10 | M3 | Done (2026-09-10) — AC 5 proven against the spawned server; the ROPC token endpoint is the owner's sitting |
| ARC-07-S07 | ARC-07 | `--global` store, project-wins precedence messaging, cloud-sync-folder warning (D-04) | M | S05, S06; ARC-04-S02; ARC-06-S05; ARC-08-S03 | M3 | Done (2026-09-10) — the OneDrive environment roots are unit-tested with a stubbed env; a real Known-Folder-Move machine is the owner's sitting |
| ARC-07-S08 | ARC-07 | `instance import --from-legacy`: dry-run plan, field and flag mapping, explicit `FLUENT_ENABLED`, prod cap, deletion advice | M | S04, S05, S07; ARC-04-S02 | M3 | Done (2026-09-10) — the tolerant reader meets real 1.x data only at the owner's sitting |
| ARC-07-S09 | ARC-07 | `/snowarch setup-instance` skill body: prerequisite check, three `AskUserQuestion`s, printed command per OS, `--resume` with reload + doctor, S-02 fallback | M | S05, S06; ARC-00-S04/S10/S12; ARC-02-S11; ARC-04-S04; ARC-08-S01; verdicts S-02 S-16 S-19 | M3 | Done (2026-09-10) — T-20/T-21 are manual passes (macOS + the Windows gitbash snapshot, two CLI versions): the owner's sitting |
| ARC-07-S10 | ARC-07 | `docs/MODES-AND-PRESETS.md` final text; error-registry entries; runtime rule text for `AUTHENTICATION_FAILED` / `INSUFFICIENT_PRIVILEGES` / `PROD_WRITE_NOT_ACKNOWLEDGED` | M | S02, S08; ARC-02-S09; ARC-05-S05/S06 | M3 | Done (2026-09-10) — AC 5's password managers and the outside read-through are the owner's sitting |
| ARC-07-S11 | ARC-07 | Live E2E suite behind `RUN_LIVE_E2E=1`: wizard end to end, three-failure exit with lockout check, prod cap, ROPC-disabled fixture, import | M | S05, S08; ARC-06-S08 | M3 | Done (2026-09-10) — the suite, the helper and the workflow ship; the PDI, the secrets, case 5's write and the fixture are the owner's sitting |
| ARC-08-S01 | ARC-08 | Doctor framework: check registry, sections, severities, remedies from the contract, JSON schema, exit codes, redaction | L | ARC-04-S12; ARC-05-S06/S10; ARC-06-S02 | M3 | Done (2026-09-10) |
| ARC-08-S02 | ARC-08 | Engine checks E-00…E-22: prerequisites, repo wiring, docs corpus, roster, contract | L | S01; ARC-01-S04; ARC-03-S06; ARC-05-S03/S04; ARC-06-S01/S05 | M3 | Done (2026-09-10) — AC 1 (0 FAIL on a bootstrapped reference machine) is the owner's sitting: this clone is not bootstrapped, so E-10/E-11 report it truthfully and the green case is proved by fixtures |
| ARC-08-S03 | ARC-08 | Stale-registration, legacy-store, cloud-sync, proxy/CA and registration-status detectors (E-23…E-27) with exact commands | M | S01; ARC-00-S04; ARC-04-S02/S11; ARC-06-S05/S12; verdicts S-01 | M3 | Done (2026-09-10) — the real-leftover run and the Windows `claude mcp get` are the owner's sitting (D2); every detector is fixture-proved in CI |
| ARC-08-S04 | ARC-08 | Server checks SV-00…SV-07 integrated: module import, probe wiring (basic + ROPC), FLUENT SDK, capabilities equality, section `server` | M | S01; ARC-04-S04/S12; ARC-07-S03 | M3 | Done (2026-09-10) — the live half of AC 1 and AC 8 (RUN_LIVE_E2E against a PDI) are the owner's sitting; every other criterion is fixture-proved on both sides |
| ARC-08-S05 | ARC-08 | Merged report, the authoritative `Mode:` line, `--quick` / `--no-network` / `--section`, capability packs, `.local/doctor-last.json` | M | S01, S02, S04 | M3 | Done (2026-09-10) — the live Mode line and the `--quick` budget on the reference machine are the owner's sitting; every variant is fixture-proved |
| ARC-08-S06 | ARC-08 | `--fix` whitelist with per-fix reporting and refusal rules | L | S02, S03, S04, S05; ARC-03-S05; ARC-06-S05/S06/S07 | M3 | Done (2026-09-10) — the reference-machine run after a deliberate drift is the owner's sitting; the composite fixture proves every fixer in CI |
| ARC-08-S07 | ARC-08 | Old→new check mapping table (`D00–D37` → `E-xx` / `SV-xx` / retired) in `docs/ARCHITECTURE.md` | S | S02, S03, S04 | M3 | Done (2026-09-10) |
| ARC-08-S08 | ARC-08 | `hooks/session-start.mjs` banner: cache, staleness re-run, nudges, hook timeout, S-05 handling | M | S05; ARC-00-S06; ARC-06-S01/S05; verdicts S-05 | M3 | Done (2026-09-10) — AC 6, AC 7's manual half and task 5 (plain stdout vs additionalContext in a real session) are the owner's sitting D3 |
| ARC-08-S09 | ARC-08 | `/snowarch status` skill body: doctor-JSON rendering and the no-Node fallback | M | S05, S08; ARC-02-S11; ARC-07-S09 | M3 | Done (2026-09-10) — AC 6 and the four session runs (live, design-only, Windows, no-Node) are the owner's sitting D4 |
| ARC-08-S10 | ARC-08 | Runtime error mapping in the generated rule file; VALIDATION-TESTS T-19 (`AUTHENTICATION_FAILED`) and T-22 (`*_NOT_ENABLED`) | M | S05; ARC-02-S13; ARC-05-S05/S06; ARC-07-S10 | M3 | Done (2026-09-10) — AC 3 and AC 4 (T-19 and T-22 executed live, and the two dormant variants) are the owner's sitting D5; the second test is T-22, not T-20 (see the story amendment) |
| ARC-08-S11 | ARC-08 | CI: doctor after bootstrap on three OSes, JSON snapshot test, fixture-driven detector tests, banner timing | M | S02, S10; ARC-00-S13; ARC-06-S14 | M3 | Done (2026-09-11) — the reference-machine doctor run (D1) and the live/session criteria (D2–D5) are the owner's sitting; the red/green drills are PRs #120 and #121, closed unmerged |
| ARC-09-S01 | ARC-09 | `scripts/release.mjs`: preflight, gates, version writes, release commit, annotated tag with contract sha and docs pin | L | ARC-01-S06/S11; ARC-02-S08; ARC-03-S06; ARC-04-S13; ARC-05-S09 | M4 | Done (2026-09-11) — AC 8 (the Windows dry run) is S03's `release-dryrun` job; the first REAL run is the 2.0.0 release itself and is the owner's |
| ARC-09-S02 | ARC-09 | `docs/CHANGELOG.md` generation from conventional commits; commit-message lint in CI; the 2.0.0 "supersedes" and migration notes | M | S01; ARC-04-S14 | M4 | Done (2026-09-11) — AC 5's red half is drill PR #126 (closed unmerged, branch deleted) and the green half is this PR's own `commitlint` job; `commitlint` is the 43rd required context and the protection change is the Chief Architect's at the M4 merge |
| ARC-09-S03 | ARC-09 | `.github/workflows/release.yml`: on `v*` tags re-run every gate on three OSes, create the GitHub Release with doctor JSON and install-metrics assets | M | S01, S02; ARC-03-S05/S11; ARC-06-S03/S14; ARC-08-S01/S11 | M4 | Done (2026-09-11) — the rehearsal (AC 1–5: a prerelease tag creating a PUBLIC Release) is run by the architect with the owner's approval; the procedure is in the PR and the placeholders are in CONTRIBUTING |
| ARC-09-S04 | ARC-09 | `./snowarch version` extended (tag, commit, tag-message comparison; `--json` superset of ARC-06-S02's shape; feeds the doctor's `engine` header) | S | S01; ARC-03-S01; ARC-05-S10; ARC-06-S02; ARC-08-S01 | M4 | Done (2026-09-11) — AC 6 (`snowarch.cmd version` six lines) is asserted in the `windows launcher` cell; the tagged states are fixtures because the repository carries no `v*` tag yet |
| ARC-09-S05 | ARC-09 | Input-hash invalidation table: `lib/inputs.mjs`, `state.staleSteps()`, `tests/input-hash.test.mjs`, `docs/ARCHITECTURE.md` section | M | ARC-03-S02; ARC-04-S06; ARC-06-S03 | M4 | Done (2026-09-11) — AC 3's cached lines read `ok (cached)`, not `skipped (…)`: in the same output `skipped` already means `runsWhen` declined and is counted separately. `staleSteps()` gained an `alwaysRuns` seam so B00/B09 (no inputs, `cacheable = false`) are excluded rather than reported `launcher-recorded`. The store stamp is truncated to the second — `utimesSync` rounds, so AC 2's restored mtime is never byte-equal. Cross-OS parity is asserted per cell against `git cat-file` rather than by a collector job, which would add a required context |
| ARC-09-S06 | ARC-09 | Store schema migration framework in `packages/snowarch` (explicit, versioned, 0600 backup, credential values never touched) | M | ARC-04-S02/S04/S06/S12; ARC-05-S06; ARC-08-S04 | M4 | Done (2026-09-11) — doctor check is **SV-09** (SV-08 was taken by ARC-08-S04). `STORE_SCHEMA_UNSUPPORTED` **split** into `STORE_SCHEMA_OUTDATED` / `STORE_SCHEMA_NEWER`: one code gave one remedy, and "run upgrade" is wrong for a store from the past. The test seam is `migrateStore`'s `migrations` parameter, not a shipped `registerMigrationForTest` hook. AC 2 is a round trip (migrate → restore → a real server loads it): at v1 there is no store below to migrate FROM. Contract gains `storeSchemaVersion`; pin bumped 7f798598a38e → 4117dc73744e |
| ARC-09-S07 | ARC-09 | `./snowarch upgrade [--to vX.Y.Z] [--check]`, the SessionStart "behind origin" nudge, and the upgrade fixture harness | L | S04, S05, S06; ARC-06-S03/S09; ARC-08-S08 | M4 | Done (2026-09-11) — the release-currency check is **E-28** (ARC-08-S03 took E-27). A re-run after a failed step CONTINUES instead of reporting `up to date`. AC 7's interrupt is planted, not timed. Found and fixed a live defect: B06 read `.status` off the runner's ASYNC spawn, so the instance wizard was declared failed the moment it started — both spawn paths now await the child. `upgrade-e2e` adds three required contexts; no registry text moved, so the pin is untouched |
| ARC-09-S08 | ARC-09 | CI matrix completion: every job on the intended cells; the Windows job without Git Bash (launchers, `--password-stdin`, MCP handshake, hook in exec form) | L | S02, S03, S07, S09; ARC-00-S06/S07/S13; ARC-03-S02/S11; ARC-04-S13; ARC-05-S09; ARC-06-S08/S14; ARC-07-S01/S04/S05; ARC-08-S11 | M4 | Done (2026-09-11) — `windows-native` (3 cells, `cmd.exe` throughout) ADDS to ARC-06-S14's `no-gitbash` cell rather than replacing it; `strip-git-bash.mjs` is one implementation shared by both. `tests/fixtures/required-contexts.json` is GENERATED from `ci.yml` at **52** contexts at the time (S09 took it to 54) and the generator fails loudly on a job it cannot classify — verified against a live run, which caught it naming thirteen bootstrap cells no run produces. Chores C3, C4, C5, C6, C7 landed in the first two commits |
| ARC-09-S09 | ARC-09 | Line-ending proof: `tests/eol.test.mjs` over `git ls-files --eol`; launchers run from a CRLF-default Windows checkout | S | ARC-01-S07; ARC-06-S10/S11 | M4 | Done (2026-09-11) — the policy read from git, not from the files: the INDEX column holds everywhere (git normalises on `add`), the WORKTREE column only where a clone just happened, so the `eol` job sets `core.autocrlf=true` BEFORE the checkout and the unit test skips the worktree case on a tree that is not fresh. `tests/eol.allowlist.json` answers the 8 extensions and 8 extensionless names left to `text=auto`, each with a reason; the completeness check reads `.gitattributes` and git's resolved attributes, never a hand list. AC 4 and AC 5 are fixture repositories judged by the SAME predicates as the repository, not throwaway PRs. `scripts/ci/assert-crlf.mjs` / `assert-lf.mjs` read bytes rather than git's opinion of them. **54** required contexts (52 → 54; `eol (ubuntu-latest)`, `eol (windows-latest)`) |
| ARC-09-S10 | ARC-09 | Optional `publish-npm.yml`: `npm publish --provenance` of `@farstic/snowarch` from a release tag, manual dispatch, dry-run by default (roadmap `01` §17 item 2) | S | S01, S03; ARC-04-S01 | M4 | Done (2026-09-11) — the workflow, the guard and the tests; **the first dispatch is the owner's** and is deferred to the acceptance phase with `NPM_TOKEN` (owner decision 2026-09-11), so no tag, no dispatch and no publish by the developer. Dispatch-only (`workflow_dispatch` and nothing else), `dry_run` defaults to **true**, and `scripts/ci/assert-publish-target.mjs` refuses anything but `@farstic/snowarch` — naming D-01 when it sees `@farstic/snow-mcp` — before `npm ci` and before the token is used. `publishConfig.provenance` added and `repository` written in the object form npm's provenance check reads. Required contexts stay **54**: a manual-dispatch workflow cannot be required, and a new reverse assertion now fails when any workflow is neither the gating one nor excluded with a reason. OPEN for the owner: the tarball carries LICENSE but no NOTICE (Apache-2.0 §4(d)) — recorded as Sitting E |
| ARC-09-S11 | ARC-09 | `docs/CONTRIBUTING.md` release / upgrade / CI-matrix sections; `docs/INSTALL.md` "Upgrading" section; `docs/ARCHITECTURE.md` versioning section | S | S01, S10 | M4 | Done (2026-09-11) — the six CONTRIBUTING sections by their exact anchors (`commits`, `releasing`, `store-migrations`, `upgrading-the-product`, `ci-matrix`, `line-endings`), each ending in a **Where this is tested** line that names a real file or CI cell; the release checklist with the **two-phase flow as THE flow** (`main` is `strict` with 54 required checks, so a release commit pushed straight to it carries none and is refused by the branch); INSTALL's *What to paste in a bug report* (budget 268 → **277**, ARC-07-S10's ruling, nothing deleted); ARCHITECTURE's *Versioning, tags and upgrade*. `tests/docs-links.test.mjs` is NEW, not extended — ARC-05-S04's path check is lint rule L05 — and checks required anchors, every internal link's heading, every fenced `./snowarch` / `node scripts/` / `npm run` command, and the six tested-lines' targets. It found four dead anchors on its first run, two of them printed by `./snowarch upgrade` itself. AC 3 walked on the S07 harness: four refusals in a row, each naming its own remedy. **ARC-09 and M4 close here** |
| ARC-09-S12 | ARC-09 | Semver prerelease ordering: one comparator (`tools/snowarch/lib/semver.mjs`) for the release preflight, the upgrade's tag sort and E-28 | M | ARC-09-S03, ARC-09-S07 | M5 | Done (2026-09-23) — found cutting rc.10: `release: 2.0.0-rc.10 is not greater than the latest tag v2.0.0-rc.9`. The prerelease compared as a string, so `"rc.10" < "rc.9"`. **Two copies, written separately and wrong identically** — `compareVersions` in the release preflight and `sortTags` in the engine. The refusal was the loud half; the quiet half was that `./snowarch upgrade --pre` takes `sortTags[0]` as its target, so a checkout on rc.9 would have been told it was already newest and never offered rc.10, and E-28 reads the same order so the doctor would have agreed — two instruments, one wrong answer, nothing to disagree with. Now §11 implemented once: numeric fields numerically, numeric below alphanumeric, more fields beating fewer, a release above its prereleases; an unparseable version throws rather than ranking, because a comparator returning 0 tells `Array.sort` they are the same version. Tests: the specification's own eight-version example asserted as every pair (transitivity, not just neighbours), rc.10/rc.11/rc.100, `release.mjs` cutting rc.10 while rc.9 is latest, and an upgrade test that a checkout on rc.9 resolves rc.10 and `--check` reports it |
| ARC-10-S01 | ARC-10 | `docs/MIGRATION.md`: existing-user step list and the cleanup command list derived from the ARC-08 detectors | M | ARC-01-S10; ARC-06-S13; ARC-07-S08; ARC-08-S01/S03/S10 | M5 | Done (2026-09-12) |
| ARC-10-S02 | ARC-10 | Engagement-state carry-over: `clients/` per checkout, `memory/MEMORY.md` retired in favour of Claude Code auto memory | S | ARC-01-S07; ARC-02-S01/S08 | M5 | Done (2026-09-12) |
| ARC-10-S03 | ARC-10 | Retire the legacy scaffolding: `scripts/legacy/`, obsolete `.gitignore` lines, empty legacy-name allow-list | S | ARC-02-S12; ARC-04-S01/S14; ARC-09-S02 | M5 | Done (2026-09-12) |
