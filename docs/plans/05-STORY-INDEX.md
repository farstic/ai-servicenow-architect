...
| ARC-09-S02 | ARC-09 | `docs/CHANGELOG.md` generation from conventional commits; commit-message lint in CI; the 2.0.0 "supersedes" and migration notes | M | S01; ARC-04-S14 | M4 | Done (2026-09-11) — AC 5's two drills are PRs #125/#126, closed unmerged; `commitlint` is the 43rd required context and the protection change is the Chief Architect's at the M4 merge |
