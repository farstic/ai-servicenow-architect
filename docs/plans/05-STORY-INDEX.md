...
| ARC-07-S05 | ARC-07 | `instance add` end to end: bounded credential re-entry, atomic 0600 save, secret-free summary, the `./snowarch instance` forwarder, exit codes | L | S01, S04; ARC-04-S02/S10; ARC-06-S02/S07 | M3 | Done (2026-09-10) — AC 1/2/9-spawned/10 deferred to the owner sitting (a real instance and a terminal) |
