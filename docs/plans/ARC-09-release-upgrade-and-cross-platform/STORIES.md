...
10. **`docs/INSTALL.md`'s budget moves 252 → 268.** "How do I upgrade" is the second question an install page is asked; the detail is in `docs/CONTRIBUTING.md` § Upgrading the product, linked from it.
