...
import { CURRENT_SCHEMA_VERSION, listBackups, migrateStore, restoreBackup, } from '../store/migrations/index.js';
export const defaultStoreIo = () => ({
...
export async function runStore(args, io = defaultStoreIo()) {
